...
const FormLogin = () => {
  ...
  const handleEmailBlur = () => {
    if (formData.email.trim() === "") {
      setErrors({ ...errors, email: t("login_email_required") });
    } else {
      setErrors({ ...errors, email: "" });
    }
  };
  ...
  const handlePasswordBlur = () => {
    if (formData.password.trim() === "") {
      setErrors({ ...errors, password: t("login_password_required") });
    } else {
      setErrors({ ...errors, password: "" });
    }
  };
  ...
  return (
    <div className="App">
      <form onSubmit={handleSubmit}>
        ...
        <NavLink to="/register">
          <p className="register">{t("login_register_message")}</p>
        </NavLink>
      </form>
    </div>
  );
